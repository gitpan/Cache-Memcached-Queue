# This Makefile is for the Cache::Memcached::Queue extension to perl.
#
...
#     CONFIGURE_REQUIRES => {  }
#     LICENSE => q[perl]
#     NAME => q[Cache::Memcached::Queue]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0] }
#     VERSION_FROM => q[lib/Cache/Memcached/Queue.pm]
#     clean => { FILES=>q[Cache-Memcached-Queue-*] }
...
MAN3EXT = 3pm
INSTALLDIRS = site
INSTALL_BASE = /home/bangolino/perl5
DESTDIR = 
PREFIX = $(INSTALL_BASE)
...
MAKEMAKER   = /home/bangolino/perl5/lib/perl5/ExtUtils/MakeMaker.pm
MM_VERSION  = 6.62
MM_REVISION = 66200
...
MAKE = make
FULLEXT = Cache/Memcached/Queue
BASEEXT = Queue
PARENT_NAME = Cache::Memcached
DLBASE = $(BASEEXT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Cache/Memcached/Queue.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Cache/Memcached
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Cache/Memcached
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Cache/Memcached/Queue.pm $(INST_MAN3DIR)/Cache::Memcached::Queue.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '  - '\''Andre Garcia Carneiro <andregarciacarneiro@gmail.com>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Cache-Memcached-Queue' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '      "Andre Garcia Carneiro <andregarciacarneiro@gmail.com>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Cache-Memcached-Queue",' >> META_new.json
